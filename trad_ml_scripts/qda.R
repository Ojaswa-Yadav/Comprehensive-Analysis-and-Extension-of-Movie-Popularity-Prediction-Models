...
qda_classification <- function(train_data, test_data, target_variable, label_mapping) {
...
predictions_gross_conv <- qda_classification(train_conv, test_conv, "GrossLabel", gross_label_mapping)
predictions_gross_social <- qda_classification(train_social, test_social, "GrossLabel", gross_label_mapping)
predictions_rating_conv <- qda_classification(train_conv, test_conv, "RatingLabel", rating_label_mapping)
predictions_rating_social <- qda_classification(train_social, test_social, "RatingLabel", rating_label_mapping)
predictions_gross_full <- qda_classification(train_full, test_full_features, "GrossLabel", gross_label_mapping)
predictions_rating_full <- qda_classification(train_full, test_full_features, "RatingLabel", rating_label_mapping)
